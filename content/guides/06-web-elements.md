...
For more on how and why we use alt text, read the [Accessibility]({{< ref "guides/12-writing-for-accessibility.md" >}}) section.
...
- Yes: Read the [automation guide](#links) for details.
- No: Read [the automation guide](#links) for details.
